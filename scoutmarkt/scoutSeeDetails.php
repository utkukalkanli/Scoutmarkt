...
<br>
<d> Your Selected Player's ID: </d>
  <input type="text" id="selectedP" name="selectedP">
<d> Your Comment: </d>
  <input type="text" id="commentID" name="commentID"><br>

<br><br>

<form action="/action_page.php">
<d for="playerRate">Rate Player ( 0 to 5 )</d>
<select name="playerRate" id="playerRate">
...
<input type="submit" value="Add Player" onclick = "functionAddPlayer()">
</form>
  <button class="addButton" onclick="window.location.href='scoutSeeDetails.php'">Add Another Player</button>
  <button class="addButton">Save & Close </button>
</div>
